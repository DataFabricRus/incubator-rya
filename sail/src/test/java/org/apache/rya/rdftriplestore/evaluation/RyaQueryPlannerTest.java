...
public class RyaQueryPlannerTest {
    ...
    static {
        try {
            Model model = Rio.parse(
                    RyaQueryPlannerTest.class.getResourceAsStream(
                            RyaQueryPlannerTest.class.getSimpleName() + "/prefixes.ttl"),
                    "",
                    RDFFormat.TURTLE
            );
    ...
    public RyaQueryPlannerTest(String filePrefix) {
    ...
    public void test() throws Exception {
        ...
        new RyaQueryPlanner(createEvaluationStrategy(), createEvaluationStatistics(jsonArray))
